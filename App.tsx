...
const App = () => {
  ...
  // --- NATIVE STABLE EXOPLAYER SCREEN ---
    ...
    return (
      <View style={{flex: 1, backgroundColor: 'black', justifyContent: 'center'}}>
        <Video 
          ...
          resizeMode="contain"
          controls={true} // 🔥 Using Native ExoPlayer Controls for 100% stable BluRay & Audio/Sub support!
          useTextureView={false}
          bufferConfig={{ minBufferMs: 15000, maxBufferMs: 30000, bufferForPlaybackMs: 2500, bufferForPlaybackAfterRebufferMs: 5000 }}
        />
        <TouchableOpacity onPress={closeInternalPlayer} style={styles.floatingCloseBtn}>
    ...
    return (
      <View style={styles.selectionContainer}>
        ...
        <TouchableOpacity style={styles.primaryButton} onPress={() => setPlayMode('internal')}>
          <Text style={styles.buttonText}>Play in App (Stable Exo) 🍿</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  floatingCloseBtn: { position: 'absolute', top: 40, left: 20, backgroundColor: 'rgba(0,0,0,0.6)', padding: 10, borderRadius: 30, zIndex: 999 }
});
